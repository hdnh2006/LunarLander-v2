...
parser.add_argument('--agents', type=int, default=500, help='agents.pkl file')
parser.add_argument('--rewards', type=int, default=500, help='rewards.pkl file')
parser.add_argument('--runs', type=int, default=500, help='Number of runs the agent will be ran')
